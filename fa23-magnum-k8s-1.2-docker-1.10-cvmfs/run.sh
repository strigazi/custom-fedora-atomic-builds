...
cd /root
git clone https://github.com/strigazi/fedora-atomic.git -b fa23-k8s-1.2-docker-1.10.3-cvmfs
...
FEDORA_ATOMIC_TREE_REF=$(cat /srv/f23ah/refs/heads/fedora-atomic/f23/x86_64/docker-host)
